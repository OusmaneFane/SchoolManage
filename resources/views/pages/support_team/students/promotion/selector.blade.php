                ...
                <div class="row">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <select required id="fs" name="fs" data-placeholder="Selectionner la Classe d'abord" class="form-control select">
                                @if($selected && $fs)
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            <label for="ts" class="col-form-label font-weight-bold">A la Section:</label>
                            <select required id="ts" name="ts" data-placeholder="Selectionner la Classe d'abord" class="form-control select">
                                @if($selected && $ts)

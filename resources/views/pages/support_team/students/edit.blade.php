                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->name }}" required type="text" name="name" placeholder="Nom & Prénom(s)" class="form-control">
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->email  }}" type="email" name="email" class="form-control" placeholder="votre adresse e-amil">
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="gender" name="gender" required data-fouc data-placeholder="Choisir..">
                                    ...
                                    <option {{ ($sr->user->gender  == 'Female' ? 'selected' : '') }} value="Female">Feminin</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->phone  }}" type="text" name="Téléphone" class="form-control" placeholder="" >
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input value="{{ $sr->user->phone2  }}" type="text" name="Téléphone2" class="form-control" placeholder="" >
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            ...
                            <select required data-placeholder="Select State First" class="select-search form-control" name="lga_id" id="lga_id">
                                @if($sr->user->lga_id)
                                    <option selected value="1">{{ $sr->user->lga->name}}</option>
                                @endif
                            </select>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select onchange="getClassSections(this.value)" name="my_class_id" required id="my_class_id" class="form-control select-search" data-placeholder="Selectionner la Classe">
                                    <option value=""></option>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="section_id" required id="section_id" class="form-control select" data-placeholder="Selectionner la Section">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="year_admitted" data-placeholder="Choisir..." id="year_admitted" class="select-search form-control">
                                    <option value=""></option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input hidden type="text" name="dorm_room_no" placeholder="Dormitory Room No" class="form-control" value="{{ $sr->dorm_room_no }}">
                            </div>
                        </div>
                    </div>
                </fieldset>

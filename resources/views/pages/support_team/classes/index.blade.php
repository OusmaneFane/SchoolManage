...
@section('page_title', 'Gestion Classes')
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <ul class="nav nav-tabs nav-tabs-highlight">
                <li class="nav-item"><a href="#all-classes" class="nav-link active" data-toggle="tab">Gérer Classes</a></li>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <form class="ajax-store" method="post" action="{{ route('classes.store') }}">
                                ...
                                <div class="form-group row">
                                    <label for="class_type_id" class="col-lg-3 col-form-label font-weight-semibold">Type de la Classe</label>
                                    <div class="col-lg-9">
                                ...
                                <div class="text-right">
                                    <button id="ajax-btn" type="submit" class="btn btn-primary">Envoyer le formulaire<i class="icon-paperplane ml-2"></i></button>
                                </div>
                            </form>
                        </div>
                    </div>

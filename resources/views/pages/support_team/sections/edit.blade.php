...
@section('page_title', 'Modification de la section '.$s->my_class->name)
@section('content')

    <div class="card">
        <div class="card-header header-elements-inline">
            <h6 class="card-title">Modifier la section {{ $s->my_class->name }}</h6>
            {!! Qs::getPanelOptions() !!}
        </div>
                ...
                <div class="col-md-6">
                    <form class="ajax-update" method="post" action="{{ route('sections.update', $s->id) }}">
                        ...
                        <div class="text-right">
                            <button type="submit" class="btn btn-primary">Modifier la section <i class="icon-paperplane ml-2"></i></button>
                        </div>
                    </form>
                </div>
            </div>

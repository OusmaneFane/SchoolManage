...
@section('page_title', 'Modification Utilisateur')
@section('content')
                ...
                <fieldset>
                    ...
                    <div class="row">
                        @if(in_array($user->user_type, Qs::getStaff()))
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Date de l'embauche:</label>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="select form-control" id="gender" name="gender" required data-fouc data-placeholder="Choose..">
                                    <option value=""></option>
                                    <option {{ ($user->gender == 'Male') ? 'selected' : '' }} value="Male">Masculin</option>
                                    <option {{ ($user->gender == 'Female') ? 'selected' : '' }} value="Female">Feminin</option>
                                </select>
                            </div>
                        </div>

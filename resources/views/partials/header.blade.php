<div id="page-header" class="page-header page-header-light">
   ...
   {{--             <a href="#" class="btn btn-link btn-float text-default"><i class="icon-bars-alt text-primary"></i><span>Statistics</span></a>
                ...
                <a href="{{ Qs::userIsSuperAdmin() ? route('settings') : '' }}" class="btn btn-link btn-float text-default"><i class="icon-arrow-down7 text-primary"></i> <span class="font-weight-semibold">Session Actuelle: {{ Qs::getSetting('current_session') }}</span></a>
            </div>
        </div>
    </div>
